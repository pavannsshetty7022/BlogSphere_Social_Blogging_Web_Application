...
import { fetchPostById, reactPost, addComment, deleteComment, deletePost } from "../services/api";
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-8">
                        ...
                        <div className="animate-pulse">
                            <div className="mb-4">
                                <div className="bg-secondary bg-opacity-10 rounded" style={{ height: "48px", width: "80%" }}></div>
                            </div>

                            <div className="d-flex align-items-center mb-4">
                                <div className="bg-secondary bg-opacity-10 rounded-circle" style={{ width: "50px", height: "50px" }}></div>
                                <div className="ms-3 flex-grow-1">
                                    <div className="bg-secondary bg-opacity-10 rounded mb-2" style={{ height: "20px", width: "150px" }}></div>
                                    <div className="bg-secondary bg-opacity-10 rounded" style={{ height: "16px", width: "200px" }}></div>
                                </div>
                            </div>

                            <div className="mb-4">
                                <div className="bg-secondary bg-opacity-10 rounded mb-3" style={{ height: "20px", width: "100%" }}></div>
                                <div className="bg-secondary bg-opacity-10 rounded mb-3" style={{ height: "20px", width: "95%" }}></div>
                                <div className="bg-secondary bg-opacity-10 rounded mb-3" style={{ height: "20px", width: "98%" }}></div>
                                <div className="bg-secondary bg-opacity-10 rounded mb-3" style={{ height: "20px", width: "90%" }}></div>
                                <div className="bg-secondary bg-opacity-10 rounded mb-3" style={{ height: "20px", width: "97%" }}></div>
                                <div className="bg-secondary bg-opacity-10 rounded mb-3" style={{ height: "20px", width: "92%" }}></div>
                            </div>

                            <div className="border-top border-bottom py-3 mb-5">
                                <div className="d-flex gap-4">
                                    <div className="bg-secondary bg-opacity-10 rounded" style={{ height: "40px", width: "80px" }}></div>
                                    <div className="bg-secondary bg-opacity-10 rounded" style={{ height: "40px", width: "80px" }}></div>
                                    <div className="bg-secondary bg-opacity-10 rounded" style={{ height: "40px", width: "80px" }}></div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div className="bg-secondary bg-opacity-10 rounded mb-4" style={{ height: "32px", width: "200px" }}></div>
                                <div className="bg-secondary bg-opacity-10 rounded mb-4" style={{ height: "120px", width: "100%" }}></div>

                                {[1, 2].map((i) => (
                                    <div key={i} className="d-flex mb-4">
                                        <div className="bg-secondary bg-opacity-10 rounded-circle" style={{ width: "40px", height: "40px", flexShrink: 0 }}></div>
                                        <div className="ms-3 flex-grow-1">
                                            <div className="bg-secondary bg-opacity-10 rounded p-3">
                                                <div className="bg-secondary bg-opacity-25 rounded mb-2" style={{ height: "16px", width: "120px" }}></div>
                                                <div className="bg-secondary bg-opacity-25 rounded" style={{ height: "16px", width: "80%" }}></div>
                                            </div>
                                        </div>
                                    </div>
                                ))}
            ...
            <div className="row justify-content-center">
                <div className="col-lg-8">
                    ...
                    <article>
                            ...
                            <div className="d-flex align-items-center justify-content-between">
                                ...
                                {isAuthor && (
                                    <div className="d-flex gap-2">
                                        <button className="btn btn-outline-secondary btn-sm rounded-pill px-3" onClick={() => navigate(`/edit/${post._id}`)}>
                                            <i className="bi bi-pencil-square me-1"></i> Edit
                                        </button>
                                        <button className="btn btn-outline-danger btn-sm rounded-pill px-3" onClick={handleDeletePost}>
                        ...
                        <div className="mb-5 fs-5 lh-lg text-secondary" style={{ whiteSpace: "pre-wrap" }}>
                            {post.content}
                        </div>
                        ...
                        <div className="border-top border-bottom py-3 mb-5">
                            <div className="d-flex align-items-center gap-4 mb-3">
                                ...
                                >
                                    <i className={`bi bi-hand-thumbs-up${reaction === 'like' ? '-fill' : ''} fs-4 me-2`}></i>
                                ...
                                <button
                                    ...
                                    onMouseUp={e => e.currentTarget.style.transform = 'scale(1)'}
                                >
                                    <i className={`bi bi-hand-thumbs-down${reaction === 'dislike' ? '-fill' : ''} fs-4 me-2`}></i>
                    ...
                    <section id="comments">
                        ...
                        <form onSubmit={handleCommentSubmit} className="mb-5 bg-white p-4 rounded shadow-sm border">
                            <div className="d-flex mb-3">
                                <div className="bg-primary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center me-3" style={{ width: "45px", height: "45px", flexShrink: 0 }}>
                                    <span className="fw-bold text-primary small">{user?.name?.charAt(0).toUpperCase()}</span>
                                </div>
                                <textarea
                            ...
                            <div className="d-flex justify-content-end">
                                ...
                                >
                                    {submittingComment ? <span className="spinner-border spinner-border-sm me-2"></span> : null}
                                    Submit
                                </button>
                            </div>
                        </form>
                                ...
                                <div key={comment._id} className="d-flex mb-4 group">
                                    ...
                                    <div className="flex-grow-1">
                                        <div className="bg-light p-3 rounded-4 position-relative">
                                            ...
                                            <p className="mb-0 text-secondary small">{comment.text}</p>
                                        </div>
                                        <small className="text-muted ms-2 mt-1" style={{ fontSize: '0.75rem' }}>
