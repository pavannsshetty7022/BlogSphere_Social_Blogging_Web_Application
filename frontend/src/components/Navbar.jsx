                        ...
                        {user ? (
                            <div className="dropdown">
                                <button
                                    ...
                                    aria-expanded="false"
                                >
                                    <div className="bg-primary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center me-2" style={{ width: "38px", height: "38px" }}>
                                        <span className="small fw-bold text-primary">{getInitials(user.name)}</span>
                                    </div>
                                    <span className="d-none d-md-inline fw-medium text-dark">{user.name}</span>
                                </button>
                                <ul className="dropdown-menu dropdown-menu-end shadow border-0 mt-2 p-2 rounded-3" aria-labelledby="userNavbarDropdown">
